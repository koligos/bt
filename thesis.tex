...
average of initial values, respecting the topology
 of the graph. In the text we have used a
...
we have provided examples of run of the algorithm 
in case of ideal and reliable communication and also an outline of solution
in case of zero-mean noisy updates. Included are Matlab scripts
with algorithm implementation. More
difficult formal proofs and derivations
are not included, but we have provided  
references, where is possible to find them in the literature. In the final part, we've implemented a few simple examples  of the described algorithm, motivated by radio communication.
}
