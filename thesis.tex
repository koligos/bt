...
asymptotically obtain  an average value of the initial values in all vertices, respecting the topology of the graph, i.e. it reaches global goal using only local operations. In the text, we have used a
