...
\Example To present Gershgorin theorem practicaly, consider the graph above:
\midinsert
...
\midinsert
\picw=6cm \cinspic pictures/admitance.pdf
\clabel[admitance]{Example of admitance electrical circuit. }
\caption/f Example of admitance electrical circuit to be described with Laplacian matrix.
\endinsert
