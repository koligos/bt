...
references, where is possible to find them in the literature. In the final part, we've implemented a few simple examples  of the described algorithm.
}
...
\thanks {           %Use main language here
  %I would like to thank the supervisor of this thesis, prof.~Ing.~Jan Sýkora,~CSc., for such an interesting assignement. Also, I'd like to write here thanks to  my  beloved friends and  family, who  all form me, inspire me and motivate me as well.
  TBD.
}
\declaration { 
